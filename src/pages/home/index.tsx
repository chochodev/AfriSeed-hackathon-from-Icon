...
const Home = () => {
  return (
    <MainLayout>
      <div className='flex size-full justify-center py-[4rem] md:py-[6rem] px-[1rem] bg-neutral-100 '>
        <div className='flex flex-col md:items-center w-full max-w-[72rem] space-y-[2rem] md:text-center'>
          <h1 className='text-[2.5rem] sm:text-[2.875rem] smd:text-[3rem] lg:text-[3.25rem] font-[700]'>Fuel Africa&apos;s Innovation 
