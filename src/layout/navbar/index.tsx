    ...
    <header className='relative flex justify-center w-full px-[1rem]'>
      ...
      >
        ...
        <div className='flex justify-center'>
          <Link 
            to='/'
            className='bg-primary-600 hover:bg-primary-800 active:bg-primary-500 ease-250 text-white text-[1rem] text-center w-full max-w-[30rem] py-[0.5rem] px-[1.25rem] lg:px-[1.5rem] rounded-[8px] '
          >Connect Wallet</Link>
        </div>
      </div>}
    </header>
